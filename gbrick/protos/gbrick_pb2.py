...
_PEERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GN_CONTROLLER', index=2, number=2,
      options=None,
      type=None),
  ],
...
try:
  ...
  class InnerServiceStub(object):
    ...
    def __init__(self, channel):
      ...
      self.GetGlogicStatus = channel.unary_unary(
          '/InnerService/GetGlogicStatus',
          request_serializer=StatusRequest.SerializeToString,
          response_deserializer=StatusReply.FromString,
          )
  ...
  def add_InnerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'GetGlogicStatus': grpc.unary_unary_rpc_method_handler(
            servicer.GetGlogicStatus,
            request_deserializer=StatusRequest.FromString,
            response_serializer=StatusReply.SerializeToString,
        ),
  ...
  class PeerServiceServicer(object):
    ...
    def GetLastBlockHash(self, request, context):
      """GNC 에서 GetLastBlockHash 는 Block Height Sync 를 위해서 사용된다.
      """
      context.set_code(grpc.StatusCode.UNIMPLEMENTED)
      context.set_details('Method not implemented!')
      raise NotImplementedError('Method not implemented!')
  ...
  class GNControllerStub(object):
    ...
    def __init__(self, channel):
      ...
      """
      self.Request = channel.unary_unary(
          '/GNController/Request',
          request_serializer=Message.SerializeToString,
          response_deserializer=Message.FromString,
          )
      self.GetStatus = channel.unary_unary(
          '/GNController/GetStatus',
          request_serializer=StatusRequest.SerializeToString,
          response_deserializer=StatusReply.FromString,
          )
      self.Stop = channel.unary_unary(
      ...
      self.GetPeerList = channel.unary_unary(
          '/GNController/GetPeerList',
          request_serializer=CommonRequest.SerializeToString,
          response_deserializer=PeerList.FromString,
          )
      self.GetPeerStatus = channel.unary_unary(
          '/GNController/GetPeerStatus',
          request_serializer=PeerID.SerializeToString,
          response_deserializer=StatusReply.FromString,
          )
      self.AnnounceNewLeader = channel.unary_unary(
          '/GNController/AnnounceNewLeader',
          request_serializer=ComplainLeaderRequest.SerializeToString,
          response_deserializer=CommonReply.FromString,
          )
      self.GetRandomTable = channel.unary_unary(
          '/GNController/GetRandomTable',
          request_serializer=CommonRequest.SerializeToString,
          response_deserializer=CommonReply.FromString,
          )
      self.Subscribe = channel.unary_unary(
          '/GNController/Subscribe',
          request_serializer=PeerRequest.SerializeToString,
          response_deserializer=CommonReply.FromString,
          )
      self.UnSubscribe = channel.unary_unary(
          '/GNController/UnSubscribe',
          request_serializer=PeerRequest.SerializeToString,
          response_deserializer=CommonReply.FromString,
          )


  class GNControllerServicer(object):
    """GNController Outer Service
    """
    ...
    def Subscribe(self, request, context):
      """Subscribe 와 UnSubscribe 는 Broadcast 관련 메소드로 gbrick.proto 와 동일하게 구성되어야 한다.
      """
      context.set_code(grpc.StatusCode.UNIMPLEMENTED)
      context.set_details('Method not implemented!')
      raise NotImplementedError('Method not implemented!')
  ...
  def add_GNControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'Request': grpc.unary_unary_rpc_method_handler(
            servicer.Request,
            request_deserializer=Message.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'GNController', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
  ...
  class BetaInnerServiceStub(object):
    ...
    def GetGlogicStatus(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      raise NotImplementedError()
    GetGlogicStatus.future = None
  ...
  def beta_create_InnerService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('InnerService', 'GetGlogicStatus'): StatusRequest.FromString,
    ...
    response_serializers = {
      ...
      ('InnerService', 'GetGlogicStatus'): StatusReply.SerializeToString,
    ...
    method_implementations = {
      ...
      ('InnerService', 'GetGlogicStatus'): face_utilities.unary_unary_inline(servicer.GetGlogicStatus),
  ...
  def beta_create_InnerService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('InnerService', 'GetGlogicStatus'): StatusRequest.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('InnerService', 'GetGlogicStatus'): StatusReply.FromString,
    ...
    cardinalities = {
      ...
      'GetGlogicStatus': cardinality.Cardinality.UNARY_UNARY,
  ...
  def beta_create_PeerService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('PeerService', 'GetGlogicStatus'): StatusRequest.FromString,
    ...
    response_serializers = {
      ...
      ('PeerService', 'GetGlogicStatus'): StatusReply.SerializeToString,
    ...
    method_implementations = {
      ...
      ('PeerService', 'GetGlogicStatus'): face_utilities.unary_unary_inline(servicer.GetGlogicStatus),
  ...
  def beta_create_PeerService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('PeerService', 'GetGlogicStatus'): StatusRequest.SerializeToString,
    ...
    response_deserializers = {
      ...
      ('PeerService', 'GetGlogicStatus'): StatusReply.FromString,
  ...
  class BetaGNControllerServicer(object):
    """The Beta API is deprecated for 0.15.0 and later.
  ...
  class BetaGNControllerStub(object):
    """The Beta API is deprecated for 0.15.0 and later.
  ...
  def beta_create_GNController_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_deserializers = {
      ('GNController', 'AnnounceNewLeader'): ComplainLeaderRequest.FromString,
      ('GNController', 'ConnectPeer'): ConnectPeerRequest.FromString,
      ('GNController', 'GetChannelInfos'): GetChannelInfosRequest.FromString,
      ('GNController', 'GetPeerList'): CommonRequest.FromString,
      ('GNController', 'GetPeerStatus'): PeerID.FromString,
      ('GNController', 'GetRandomTable'): CommonRequest.FromString,
      ('GNController', 'GetStatus'): StatusRequest.FromString,
      ('GNController', 'Request'): Message.FromString,
      ('GNController', 'Stop'): StopRequest.FromString,
      ('GNController', 'Subscribe'): PeerRequest.FromString,
      ('GNController', 'UnSubscribe'): PeerRequest.FromString,
    }
    response_serializers = {
      ('GNController', 'AnnounceNewLeader'): CommonReply.SerializeToString,
      ('GNController', 'ConnectPeer'): ConnectPeerReply.SerializeToString,
      ('GNController', 'GetChannelInfos'): GetChannelInfosReply.SerializeToString,
      ('GNController', 'GetPeerList'): PeerList.SerializeToString,
      ('GNController', 'GetPeerStatus'): StatusReply.SerializeToString,
      ('GNController', 'GetRandomTable'): CommonReply.SerializeToString,
      ('GNController', 'GetStatus'): StatusReply.SerializeToString,
      ('GNController', 'Request'): Message.SerializeToString,
      ('GNController', 'Stop'): StopReply.SerializeToString,
      ('GNController', 'Subscribe'): CommonReply.SerializeToString,
      ('GNController', 'UnSubscribe'): CommonReply.SerializeToString,
    }
    method_implementations = {
      ('GNController', 'AnnounceNewLeader'): face_utilities.unary_unary_inline(servicer.AnnounceNewLeader),
      ('GNController', 'ConnectPeer'): face_utilities.unary_unary_inline(servicer.ConnectPeer),
      ('GNController', 'GetChannelInfos'): face_utilities.unary_unary_inline(servicer.GetChannelInfos),
      ('GNController', 'GetPeerList'): face_utilities.unary_unary_inline(servicer.GetPeerList),
      ('GNController', 'GetPeerStatus'): face_utilities.unary_unary_inline(servicer.GetPeerStatus),
      ('GNController', 'GetRandomTable'): face_utilities.unary_unary_inline(servicer.GetRandomTable),
      ('GNController', 'GetStatus'): face_utilities.unary_unary_inline(servicer.GetStatus),
      ('GNController', 'Request'): face_utilities.unary_unary_inline(servicer.Request),
      ('GNController', 'Stop'): face_utilities.unary_unary_inline(servicer.Stop),
      ('GNController', 'Subscribe'): face_utilities.unary_unary_inline(servicer.Subscribe),
      ('GNController', 'UnSubscribe'): face_utilities.unary_unary_inline(servicer.UnSubscribe),
    }
    server_options = beta_implementations.server_options(request_deserializers=request_deserializers, response_serializers=response_serializers, thread_pool=pool, thread_pool_size=pool_size, default_timeout=default_timeout, maximum_timeout=maximum_timeout)
    return beta_implementations.server(method_implementations, options=server_options)


  def beta_create_GNController_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('GNController', 'AnnounceNewLeader'): ComplainLeaderRequest.SerializeToString,
      ('GNController', 'ConnectPeer'): ConnectPeerRequest.SerializeToString,
      ('GNController', 'GetChannelInfos'): GetChannelInfosRequest.SerializeToString,
      ('GNController', 'GetPeerList'): CommonRequest.SerializeToString,
      ('GNController', 'GetPeerStatus'): PeerID.SerializeToString,
      ('GNController', 'GetRandomTable'): CommonRequest.SerializeToString,
      ('GNController', 'GetStatus'): StatusRequest.SerializeToString,
      ('GNController', 'Request'): Message.SerializeToString,
      ('GNController', 'Stop'): StopRequest.SerializeToString,
      ('GNController', 'Subscribe'): PeerRequest.SerializeToString,
      ('GNController', 'UnSubscribe'): PeerRequest.SerializeToString,
    }
    response_deserializers = {
      ('GNController', 'AnnounceNewLeader'): CommonReply.FromString,
      ('GNController', 'ConnectPeer'): ConnectPeerReply.FromString,
      ('GNController', 'GetChannelInfos'): GetChannelInfosReply.FromString,
      ('GNController', 'GetPeerList'): PeerList.FromString,
      ('GNController', 'GetPeerStatus'): StatusReply.FromString,
      ('GNController', 'GetRandomTable'): CommonReply.FromString,
      ('GNController', 'GetStatus'): StatusReply.FromString,
      ('GNController', 'Request'): Message.FromString,
      ('GNController', 'Stop'): StopReply.FromString,
      ('GNController', 'Subscribe'): CommonReply.FromString,
      ('GNController', 'UnSubscribe'): CommonReply.FromString,
    }
    cardinalities = {
      'AnnounceNewLeader': cardinality.Cardinality.UNARY_UNARY,
    ...
    stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer, request_serializers=request_serializers, response_deserializers=response_deserializers, thread_pool=pool, thread_pool_size=pool_size)
    return beta_implementations.dynamic_stub(channel, 'GNController', cardinalities, options=stub_options)
